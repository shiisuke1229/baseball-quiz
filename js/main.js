...

{
  ...
  const quizSet = shuffle([
    ...
    {q: '無死２, ３塁でバッターが内野ゴロを打った。２塁ランナーと３塁ランナーはどうする？', c: ['どちらもスタートを切る。', '３塁ランナーはスタートを切り、２塁ランナーは戻る。', 'どちらも戻る。'], a: '＜解説＞「ゴロ」ゴーの場面。両ランナーとも打った瞬間にスタートを切ることで、打球が外野に抜けた場合に２塁ランナーもホームインできる。ピッチャーゴロの場合は３塁ランナーが挟まれて、その間にバッターが２塁へ行く。', x: '<img src="img/scene1.png">'},    
